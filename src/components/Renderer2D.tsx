...
const Renderer2D = React.forwardRef<HTMLDivElement, RendererProps>((props, forwardRef) => {
...
Renderer2D.displayName = "Renderer";

export { Renderer2D, initialProps, initialState };
